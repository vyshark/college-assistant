// JavaScript Document
var db=require('./db');
function getButtons(rid) //function to display the hidden button
{
...
function changeVal(id) //function to return the inputed value
{
...
function callAttend(id)//function used to call callAttend if different button is pressed
{
	var x = id.substring(0,4);
	x=x+1;
	getAttend(0,x);
}
function getAttend(z,id)//function to get Attendance for particular subject
{
...
function calcBunk(id)//function that calculates the number of lectures you can miss/attend
{
	var n1='num';
...
function showBunk(a,t)//shows number of lectures you can bunk
{
...
function showAttend(a,t)//shows number of lectures you have to attend
{
...
function round_down(n)//function to round off decimal
{
